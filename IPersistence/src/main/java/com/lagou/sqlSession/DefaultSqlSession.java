...
public class DefaultSqlSession implements SqlSession {
    ...
    private boolean doUpdate( String statementId, Object... params )throws Exception {

        Executor simpleExecutor = new simpleExecutor();
        MappedStatement mappedStatement = configuration.getMappedStatementMap().get(statementId);

        return simpleExecutor.update(configuration, mappedStatement, params)>0;
    }
        ...
        Object proxyInstance = Proxy.newProxyInstance(DefaultSqlSession.class.getClassLoader(), new Class[]{mapperClass}, new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                switch ( mappedStatement.getSqlCommandType() ){
                    ...
                    default:
                        throw new Exception("sql解析异常，不存在的sql语法标签");
                }
